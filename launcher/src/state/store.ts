...
export const sensors: SensorStatus[] = [
  ...
  { id: "gateway", name: "OPNsense/OpenWrt", layer: "gateway", state: "offline", detail: "Fase 3" },
  { id: "wireguard", name: "WireGuard", layer: "gateway", state: "offline", detail: "Fase 3" },
  { id: "suricata", name: "Suricata", layer: "network", state: "offline", detail: "Fase 3/4" },
  { id: "zeek", name: "Zeek", layer: "network", state: "offline", detail: "Fase 4" },
